...
export default function ResearcherDashboard() {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      try {
        const response = await axios.get(
          "http://127.0.0.1:8000/api/coin-news",
          {
  ...
  const reportData = useMemo(() => {
    ...
    const change24h =
      liveData?.market_data?.price_change_percentage_24h ?? null;
  ...
  const runPrediction = () => {
    ...
    if (!currentPrice) {
      setPredictionResult(
        "Live data is not available yet. Please refresh and try again.",
      );
      return;
    }
      ...
      <div className="top-cards-grid">
        ...
        <div className="glass-card stat-card">
          <div>
            ...
            <h3>
              {coin === "BTC" ? "48,320" : coin === "ETH" ? "41,120" : "35,540"}
            </h3>
              ...
              <div className="days-row">
                {DAY_OPTIONS.map((item) => (
                  <button
                    ...
                    type="button"
                    className={
                      days === item ? "day-chip active-chip" : "day-chip"
                    }
          ...
          <>
            <div className="live-data-grid">
              ...
              <div className="data-box">
                ...
                <strong>
                  {formatUSD(liveData.market_data.current_price.usd)}
                </strong>
              </div>
              <div className="data-box">
                <span>24h High</span>
              ...
              <div className="data-box">
                ...
                <strong>
                  {formatUSD(liveData.market_data.market_cap.usd)}
                </strong>
              </div>
              <div className="data-box">
                <span>Total Volume</span>
                <strong>
                  {formatUSD(liveData.market_data.total_volume.usd)}
                </strong>
              </div>
              <div className="data-box">
                ...
                <strong>
                  {Number(
                    liveData.market_data.circulating_supply,
                  ).toLocaleString()}
                </strong>
              </div>
              <div className="data-box">
              ...
              <div className="data-box">
                ...
                <strong>
                  {new Date(liveData.last_updated).toLocaleString()}
                </strong>
              </div>
            </div>
        ...
        <div className="news-section">
          <div className="section-row">
            ...
            <span className="news-subtitle">
              {coinMeta.name} research updates
            </span>
          </div>
      ...
      <div className="glass-card page-panel">
        ...
        <div className="report-grid-custom">
          ...
          <div className="info-card">
            <h3>RMSE / MAE</h3>
            <p>
              {reportData.rmse} / {reportData.mae}
            </p>
          </div>
        </div>
        ...
        {!settingsData.notifications ? (
          ...
          <div className="notification-list">
            <div className="notification-item">
              <Bell size={16} />
              <span>
                Live data synced for {coinMeta.name} at{" "}
            ...
            <div className="notification-item">
              <Bell size={16} />
              <span>
                Active model is {model} with confidence{" "}
                {currentModelStats.confidence}.
              </span>
            </div>
            ...
            {predictionHistory.length > 0
              ? predictionHistory.map((item, index) => (
                  ...
                  >
                    <Bell size={16} />
                    <span>
                      {item.time}: {item.coin} · {item.model} · {item.days} →{" "}
                      {item.prediction}
                    </span>
                  </div>
                ))
        ...
        <div className="settings-grid">
          ...
          <div className="control-group">
            ...
            <select
              ...
              onChange={(e) =>
                handleSettingsChange("preferredCoin", e.target.value)
              }
            >
              {COIN_OPTIONS.map((c) => (
                <option key={c.code} value={c.code}>
          ...
          <div className="control-group">
            ...
            <select
              ...
              onChange={(e) =>
                handleSettingsChange("preferredModel", e.target.value)
              }
            >
              {MODEL_OPTIONS.map((m) => (
                <option key={m} value={m}>
          ...
          <div className="control-group">
            ...
            <select
              ...
              onChange={(e) =>
                handleSettingsChange("preferredDays", e.target.value)
              }
            >
              {DAY_OPTIONS.map((d) => (
          ...
          <div className="control-group">
            ...
            <select
              ...
              onChange={(e) =>
                handleSettingsChange("refreshRate", e.target.value)
              }
            >
    ...
    <div className="research-shell">
      ...
      <aside className={`sidebar${sidebarOpen ? " open" : ""}`}>
        ...
        <div className="sidebar-banner glass-card">
          ...
          <p>
            Track experiments, live prices, and model outcomes in one place.
          </p>
          <button
            className="buy-btn"
            type="button"
